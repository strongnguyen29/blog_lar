...
;(function (a) {
    a.expr[":"].onScreen = function (b) {
        var c = a(window), d = c.scrollTop(), e = c.height(), f = d + e, g = a(b), h = g.offset().top, i = g.height(),
            j = h + i;
...
;!function (t, e) {
    ...
    return function (t) {
        ...
        function s(t, e, r) {
            ...
            var o = t.ownerDocument, s = {"close": o.close, "open": o.open, "write": o.write, "writeln": o.writeln};
            c(o, {
        ...
        function u(t, e, r) {
            if (h.isFunction(r)) r = {"done": r}; else if ("clear" === r) return m = [], g = null, void(y = 0);
        ...
        function a(t, e) {
            var r = d + e, n = t.getAttribute(r);
            return f.existy(n) ? String(n) : n
        }

        function s(t, e) {
            var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, n = d + e;
        ...
        var u = Object.assign || function (t) {
                ...
                return t
            }, c = r(3), l = o(c), p = r(4), f = n(p), h = !1, d = "data-ps-", y = "ps-style", m = "ps-script",
            g = function () {
                function t(e) {
                    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    i(this, t), this.root = e, this.options = r, this.doc = e.ownerDocument, this.win = this.doc.defaultView || this.doc.parentWindow, this.parser = new l["default"]("", {"autoFix": r.autoFix}), this.actuals = [e], this.proxyHistory = "", this.proxyRoot = this.doc.createElement(e.nodeName), this.scriptStack = [], this.writeQueue = [], s(this.proxyRoot, "proxyof", 0)
                }
                ...
                return t.prototype.write = function () {
                    ...
                    for (var t = void 0, e = [this.proxyRoot]; f.existy(t = e.shift());) {
                        var r = 1 === t.nodeType, n = r && a(t, "proxyof");
                        if (!n) {
                    ...
                    var e = this, r = this.parser.clear();
                    ...
                    var r = this._buildScript(t), n = this._shouldRelease(r), o = this.options.afterAsync;
        ...
        !function (e, r) {
            ...
            return function (t) {
                ...
                e.__esModule = !0;
                var a = r(2), s = o(a), u = r(3), c = o(u), l = r(6), p = n(l), f = r(5), h = {
                    "comment": /^<!--/,
                    "endTag": /^<\//,
                    ...
                    return t.prototype.append = function (t) {
                        ...
                        for (var t in h) if (h.hasOwnProperty(t) && h[t].test(this.stream)) {
                ...
                "use strict";
                e.__esModule = !0;
                var r = !1, n = !1, o = window.document.createElement("div");
                try {
                    var i = "<P><I></P></I>";
                ...
                var o = r(5), i = (e.Token = function t(e, r) {
                    ...
                    return t.formatTag = function (t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                            r = "<" + t.tagName;
                        for (var n in t.attrs) if (t.attrs.hasOwnProperty(n)) {
                            r += " " + n;
                            var i = t.attrs[n];
...
"serviceWorker" in navigator && navigator.serviceWorker.getRegistrations().then(function (b) {
    b = $jscomp.makeIterator(b);
    for (var d = b.next(); !d.done; d = b.next()) d.value.unregister()
});
...
function FormError(b, d) {
    d ? $("#" + d + " .single-page-status").removeClass("alert-success hide").addClass("alert-danger").html(b) : ($(".single-page-status").removeClass("alert-success hide").addClass("alert-danger").html(b), $("html, body").animate({scrollTop: $(".single-page-status").offset().top}, "slow"))
}

function FormSuccess(b, d) {
    d ? $("#" + d + " .single-page-status").removeClass("alert-danger hide").addClass("alert-success").html(b) : ($(".single-page-status").removeClass("alert-danger hide").addClass("alert-success").html(b), $("html, body").animate({scrollTop: $(".single-page-status").offset().top}, "slow"))
}
...
function loadonlygpt() {
    googletag.cmd = googletag.cmd || [];
    var b = document.createElement("script");
    b.src = ("https:" == document.location.protocol ? "https:" : "http:") + "//www.googletagservices.com/tag/js/gpt.js";
    var d = document.getElementsByTagName("script")[0];
    d.parentNode.insertBefore(b, d)
}

function quick_search(b) {
    $.get(ajaxUrl, {type: "quick_search", str: b}).done(function (b) {
        $(".list-search-res").html(b)
    })
}

function load_comment(b, d, e) {
    var siteUrl = $('meta[property="siteurl"]').attr('content') + '/';
    $("#" + b).html('<div class="fb-comments" data-href="'+ siteUrl + d + '/" data-width="100%" width="100%" data-numposts="5" data-colorscheme="' + e + '"></div>');
    if ("undefined" !== typeof FB) FB.XFBML.parse(document.getElementById(b)); else var g = setInterval(function () {
        "undefined" !== typeof FB && (FB.XFBML.parse(document.getElementById(b)), clearInterval(g))
    }, 100)
}

var has3d = function () {
    var b = document.createElement("p"), d = {
    ...
    for (var e in d) if (d.hasOwnProperty(e) && void 0 !== b.style[e]) {
        b.style[e] = "translate3d(1px,1px,1px)";
        var g = window.getComputedStyle(b).getPropertyValue(d[e])
    }
    document.body.removeChild(b);
    return void 0 !== g && 0 < g.length && "none" !== g
}();

$(document).ready(function () {
    var siteUrl = $('meta[property="siteurl"]').attr('content') + '/';
    var themeUrl = siteUrl + 'wp-content/themes/blogtruyen/';
    var ajaxUrl = siteUrl + "wp-admin/admin-ajax.php";

    if ($("body").is("#body_home")) {
        var b = $("#intro-index").width(), d = $("#intro-index").height(), e = $("#intro-index").offset().top,
            g = $("#intro-index").offset().left + parseInt($("#intro-index").css("padding-left"));
        $(".index-intro .item").each(function () {
            var a = $(this), n = $("img", this), f = $(a).width(), c = $(a).height(), A = $(a).offset().top;
            a = $(a).offset().left;
            a >= g && A >= e && a + f <= g + b && A + c <= e + d && (n.attr("src", n.attr("lazysrc")), n.attr("lazysrc", ""))
        })
    }
    has3d && $("html").addClass("csstransforms3d");
    var truyenAscii = $("#truyen-ascii").val(), tenTruyen = $("#ten-truyen").val(), truyenId = $("#truyen-id").val();

    if($("body").is("#body_book") || $("body").is("#body_chapter")) {
        console.log('Update view');
        $.post(ajaxUrl, {
            action: 'blogtruyen_ajax',
            type: "update_views",
            bookid: truyenId,
            t: (new Date).getTime()
        });
    ...
    $(".navbar").on("click", ".logout-link", function () {
        $.post("/login.php", {type: "logout", hash: $(".logout-link").data("hash")}).done(function (a) {
            if ("success" == a.status) setTimeout(function () {
                location.reload()
            }, 1E3); else if ("error" == a.status) return alert("C\u00f3 l\u1ed7i x\u1ea3y ra, vui l\u00f2ng b\u00e1o cho admin n\u1ebfu c\u00f3 th\u1ec3."), !1
        })
    });
    ...
    if (tenTruyen) {
        var m = $.cookie("bgcolor-cookie"), t = $.cookie("font-cookie"), u = $.cookie("size-cookie"),
            x = $.cookie("lineheight-cookie"), D = $.cookie("fluid-switch-cookie"),
            E = $.cookie("onebreak-switch-cookie"), y = $("#chapter-bnum").val(), z = $("#chapter-num").val(),
            p = "light";

        "#232323" == m && (p = "dark");
        m && "#F4F4F4" != m && $("#truyen-background").val(m), changeReaderBg(m, p, themeUrl);

        t ? $("#font-chu").val(t) : $.browser.mobile && $("#font-chu").val("Arial, sans-serif");
        t && $(".chapter-c").css("font-family", t);

        u ? $("#size-chu").val(u) : $.browser.mobile || $("#size-chu").val("22px");
        u && $(".chapter-c").css("font-size", u);

        x && "180%" != x ? $("#line-height").val(x) : $("#line-height").val("180%");
        x && $(".chapter-c").css("line-height", x);

        D == 1 && ($("#fluid-no").attr("checked", !1), $("#fluid-yes").attr("checked", !0));
        D == 1 && $(".chapter").removeClass("container").addClass("container-fluid");

        E != 1 && ($("#onebreak-no").attr("checked", !1), $("#onebreak-yes").attr("checked", !0));
        E != 1 && $(".chapter-c").html($(".chapter-c").html().replace(/<\/p>/gi, "</p><br>"));

        $("#truyen-background").on("change", function () {
            changeReaderBg(this.value, p, themeUrl);
        });
        ...
        $(document.body).on("click", ".chapter .toggle-nav-open", function () {
            1 == $.cookie("hidenav-cookie") ? ($(".navbar").slideDown(300), $(this).html('<span class="glyphicon glyphicon-menu-up"></span>'), $(".chapter").css("margin-top", "0"), $.removeCookie("hidenav-cookie", {path: "/"})) : ($(".navbar").slideUp(300), $(this).html('<span class="glyphicon glyphicon-menu-down"></span>'), $(".chapter").css("margin-top", "10px"), $.cookie("hidenav-cookie", 1, {
                expires: 365,
                path: "/"
            }))
        });
        ...
        $('input[name="onebreak-switch"]').click(function () {
            "no" == this.value ? ($(".chapter-c").html($(".chapter-c").html().replace(/(<\/p>\s*\n?<br\s*\/?>)/gi, "</p>")), $.cookie("onebreak-switch-cookie", 1, {
                expires: 365,
                path: "/"
            })) : ($(".chapter-c").html($(".chapter-c").html().replace(/(<\/p>)/gi, "</p><br>")), $.removeCookie("onebreak-switch-cookie", {path: "/"}))
        });
        ...
        $(".chapter-nav").on("click", "button.chapter_jump", function () {
            ...
            $.get(ajaxUrl, {
                ...
                var b = "";
                y && (b = "quyen-" + y + "-");
                a = a.replace(new RegExp(b + "chuong-" + z + '">', "g"), b + "chuong-" +
                    z + '" selected>');
        ...
        $(".chapter-nav").on("click", "button#chapter_error", function () {
            ...
            "" === a ? alert("B\u1ea1n ch\u01b0a nh\u1eadp m\u00f4 t\u1ea3. B\u00e1o l\u1ed7i kh\u00f4ng th\u00e0nh c\u00f4ng.") : ($("button#chapter_error").addClass("hide"), $.post(ajaxUrl, {
                action: 'blogtruyen_ajax',
                type: "chapter_report",
                chapterid: $("#chapter-id").val(),
                bookid: truyenId,
                message: a
        ...
        $(".chapter-nav").on("click", "button#chapter_comment", function () {
            ...
            load_comment("fb-comment-chapter", $('.truyen-title').attr('href'), p)
        });
        $.post(ajaxUrl, {
            action: 'blogtruyen_ajax',
            type: "update_views",
        ...
        var historyStr = $.cookie("read_history");
        var historyObj;
        var bookID = $('#truyen-id').val();
        var chapterHistory = {
            "book_id" : bookID,
            "book_name": $('.truyen-title').attr('title'),
            "book_url": $('.truyen-title').attr('href'),
            "chapter_name": $('.chapter-title').attr('title'),
            "chapter_url": $('.chapter-title').attr('href'),
            "chapter_num": $('#chapter-num').val()
        };

        console.log(historyStr);

        if(historyStr == null) {
            historyStr = JSON.stringify([chapterHistory]);
        } else {
            historyObj = JSON.parse(historyStr);
            for(var i = 0; i < historyObj.length; i++) {

                if(historyObj[i].book_id == bookID) {
                    historyObj.splice(i, 1);
                    break;
                }
            }
            historyObj.unshift(chapterHistory);
        ...
        console.log(historyStr);
        $.cookie("read_history", historyStr, {expires: 365, path: "/"})
    }
    var v = null;
    $("#search-input").keyup(function () {
        ...
        clearTimeout(v);
        a = $(this).val();
        0 == a.length ? $(".list-search-res").html("").addClass("hide") : 3 <= a.length && ($(".list-search-res").html('<img src="'+ themeUrl+'assets/img/loading-search.gif" alt="loading">').removeClass("hide"), v = setTimeout(function () {
            quick_search(a)
        }, 300))
    });
    $("#search-input").bind("paste", function () {
        ...
        setTimeout(function () {
            var b = $(a).val();
            0 == b.length ? $(".list-search-res").html("").addClass("hide") : 3 <= b.length && ($(".list-search-res").html('<img src="'+ themeUrl+ 'assets/img/loading-search.gif" alt="loading">').removeClass("hide"), v = setTimeout(function () {
                quick_search(b)
            }, 300))
        }, 0)
    });
    ...
    $(".top-nav").on("click", "div", function () {
        var a = $(this), b = a.attr("data-type");

        if (a.hasClass("active")) return !1;

        loadListTruyenTop(ajaxUrl, b, a);
    });
    ...
    $("#list-chapter").on("submit", "#page_jump", function (a) {
        ...
        var b = $("h1").text();
        a = $("#total-page").val();
        var f = parseInt($("input[name='page']").val(), 10);
        f > a && (f = a);
        isNumber(f) && 0 === f % 1 && $.get(ajaxUrl, {
            type: "list_chapter",
            tid: truyenId,
            tascii: truyenAscii,
            tname: b,
            ...
            $("#list-chapter>.row").html(truyenAscii);
    ...
    $("div.pagination-container").on("click", "ul.pagination a", function (e) {
        e.preventDefault();
        loadListChapters(ajaxUrl, $(this).attr("data-page"), themeUrl);
    });
    ...
    if ($("#body_home").length) {
        var w = function () {
            ...
            loadListTruyenHot(ajaxUrl, id);
            clearTimeout(q);
            q = setTimeout(w, 6E4)
        };

        var q = setTimeout(w, 10000);
        loadListTruyenHot(ajaxUrl, 0);
        loadListTruyenMoi(ajaxUrl, 0);

        // Show truyen dang doc
        var historys = JSON.parse($.cookie('read_history'));
        console.log(historys);
        if(historys != null) {
            var htmlMobile = '<div class="list list-truyen list-history col-xs-12 col-sm-12 col-md-8 col-truyen-main">' +
                '    <div class="title-list">' +
                '        <h2>Truyện đang đọc</h2></div>';

            var htmlDesktop = '<div class="list list-truyen list-history col-xs-12">' +
                '    <div class="title-list"><h2>Truyện đang đọc</h2></div>';
            ...
            for (var i=0; i< historys.length; i++) {
                ...
                htmlMobile += '<div class="row">' +
                    ...
                    '            <h3 itemprop="name">' +
                    '                <a href="'+ history.book_url +'">'+ history.book_name +'</a>' +
                    '            </h3>' +
                    '        </div>' +
                    '        <div class="col-xs-5 col-sm-6 col-md-4 text-info">' +
                    '            <a href="'+ history.chapter_url +'">' +
                    '                Đọc tiếp <span class="chapter-text"><span>chương</span></span> ' + history.chapter_num +
                    '            </a>' +
                    '        </div>' +
                    '    </div>';

                htmlDesktop += '<div class="row">' +
                    '        <div class="col-md-5 col-lg-7">' +
                    '            <span class="glyphicon glyphicon-chevron-right"></span>' +
                    '            <h3 itemprop="name">' +
                    '                <a href="'+ history.book_url +'">' + history.book_name +
                    '                </a>' +
                    '            </h3>' +
                    '        </div>' +
                    '        <div class="col-md-7 col-lg-5 text-info">' +
                    '            <a href="'+ history.chapter_url +'">Đọc tiếp C'+ history.chapter_num +'</a>' +
                    '        </div>' +
                    '    </div>';
            }
            ...
            htmlMobile += '</div>';
            htmlDesktop += '</div>';
            $('#history-holder').replaceWith(htmlMobile);
            $('#history-holder-side').replaceWith(htmlDesktop);
        }

        $("#hot-select").on("change", function () {
            var a = $(this).find(":selected").val();
            loadListTruyenHot(ajaxUrl, a);
            clearTimeout(q);
            q = setTimeout(w, 6E4)
        });
        ...
        $("#new-select").on("change", function () {
            ...
            loadListTruyenMoi(ajaxUrl, catId);
        });

        $(".index-intro").hover(function () {
            clearTimeout(q)
        }, function () {
            q = setTimeout(w, 6E4)
        });
    } else if ($("#body_book").length || $("#body_archive").length) {

        loadListTruyenTop(ajaxUrl, 'day', false);
    }

    $("#contact-form").submit(function (a) {
        a.preventDefault();
        a = $("#contact-name").val();
        var b = $("#contact-email").val(), f = $("#contact-subject").val(), c = $("#contact-message").val(),
            d = $("#contact-secure").val();
        if (!a || !f || !c) return FormError("B\u1ea1n vui l\u00f2ng \u0111i\u1ec1n \u0111\u1ee7 th\u00f4ng tin li\u00ean h\u1ec7.", "contact-container"), !1;
        ...
        $.post(ajaxUrl, {type: "contact", name: a, email: b, subject: f, message: c, secure: d}).done(function (a) {
            FormEnable(".single-page-form");
            "success" == a.status ? (FormSuccess("B\u1ea1n \u0111\u00e3 g\u1eedi n\u1ed9i dung li\u00ean h\u1ec7 th\u00e0nh c\u00f4ng! / Your message was sent successfully!", "contact-container"), $("#contact-form").trigger("reset"), $("#contact-secure").val(a.token)) : FormError("G\u1eedi n\u1ed9i dung li\u00ean h\u1ec7 th\u1ea5t b\u1ea1i, b\u1ea1n vui l\u00f2ng th\u1eed l\u1ea1i sau ho\u1eb7c g\u1eedi email tr\u1ef1c ti\u1ebfp \u0111\u1ebfn contact@blogtruyen.net / Error, please try again later or send email directly to contact@blogtruyen.net", "contact-container")
        })
    });
    $(".pagination-container").on("submit", "#page_jump", function (a) {
        a.preventDefault();
        a = $("input[name='page_type']").val();
        var b = $("input[name='page']").val(), f = $("input[name='filter']").val();
        a ? isNumber(b) && 0 === b % 1 && (window.location.href = siteUrl + a + "/" + truyenAscii + f + "/trang-" + b + "/") : isNumber(b) && 0 === b % 1 && (window.location.href = siteUrl + truyenAscii + "/trang-" + b + "/#list-chapter")
    });
    $("#chapter-nav-top, #chapter-nav-bot").on("change", ".chapter_jump", function () {
        $("option:selected", this);
        var a = this.value;
        a && tenTruyen && (window.location.href = siteUrl + tenTruyen + "/" + a + "/")
    });

    $(".rate-holder").raty({
        number: 10,
        path: themeUrl + 'assets/img',
        ...
        click: function (a) {
            ...
            $.post(ajaxUrl, {action: 'blogtruyen_ajax',type: "rate", data: a, bookid: truyenId});
            localStorage.setItem(truyenId, "rated");
            alert("C\u1ea3m \u01a1n b\u1ea1n \u0111\u00e3 \u0111\u00e1nh gi\u00e1 truy\u1ec7n!")
        },
        readOnly: function () {
            if ("rated" == localStorage.getItem(truyenId)) return !0
        }
    });
    randomso(1, 8);
            ...
            $("div.lazyimg").each(function () {
                if ($(this).is(":onScreen")) {
                    var a = $.browser.mobile ? $(this).data("image") : $(this).data("desk-image"),
                        b = $(this).data("classname"), f = $(this).data("alt");
                    a = b ? '<img src="' + a + '" class="' + b + '" alt="' + f + '">' : '<img src="' + a + '" alt="' + f + '">';
                    $(this).replaceWith(a)
                }
            })
        };
    ...
    var isFirstClickTabChapter = true;
    $(".book-details-tab ul.nav-tabs").on("click", "li > a", function (e) {
        e.preventDefault();

        var idContent = $(this).attr('href');

        $(".book-details-tab ul.nav-tabs li").removeClass('active');
        $(this).parent().addClass('active');
        $(".book-details-tab .tab-content > div").removeClass('active in');
        $(idContent).addClass('active in');

        if(idContent == "#tab-book-list-chapter" && isFirstClickTabChapter) {
            isFirstClickTabChapter = false;
            loadListChapters(ajaxUrl, 1, themeUrl);
        }
    });
});

function loadListChapters(ajaxUrl, paged, themeUrl) {
    console.log(paged);
    var bookId = $('#truyen-id').val();

    $("#tab-book-list-chapter > .row").empty().append('<img class="loading" src="' + themeUrl + 'assets/img/loading-search.gif" alt="loading" />');
    ...
    $.get(ajaxUrl, {
        ...
        $("#tab-book-list-chapter > .row").empty().html(data);
        $("html, body").animate({scrollTop: $(".book-details-tab").offset().top}, "slow");

        document.title = "Truy\u1ec7n " + $("h1").text() + " - Trang " + paged;
        $('#paged').val(paged);

        buildPaginationListChapters();
    })
}

function changeReaderBg(colorTheme, colorDefault, themeUrl) {
    "hatsan" == colorTheme ? ($("body").css({
        "background-color": "#f2f2f2",
        "background-image": "url('"+themeUrl+"assets/img/bg_op.png')",
        "background-repeat": "repeat"
    }).removeClass("dark-background"), $(".footer").removeClass("footer-dark"), colorDefault = "light") : "sachcu" == colorTheme ? ($("body").css({
        "background-color": "#c2b49b",
        "background-image": "url('"+themeUrl+"assets/img/bg_book_op.png')",
        "background-repeat": "repeat"
    }).removeClass("dark-background"), $(".footer").removeClass("footer-dark"), colorDefault = "light") : "#232323" == colorTheme ? ($("body").css({
        "background-color": colorTheme,
        "background-image": "url('"+themeUrl+"assets/img/bg_dark.png')"
    }).addClass("dark-background"), $(".footer").addClass("footer-dark"), colorDefault = "dark") : ($("body").css({
        "background-color": colorTheme,
        "background-image": "none"
    }).removeClass("dark-background"), $(".footer").removeClass("footer-dark"), colorDefault = "light");
    $.cookie("bgcolor-cookie", colorTheme, {expires: 365, path: "/"})
}

function buildPaginationListChapters() {

    var totalPage = Number($('#total-page').val());
    var paged = Number($('#paged').val());

    var htmlPagination = '';

    if(totalPage === 1) {
        htmlPagination += '<li class="active"><span>1<span class="sr-only"> (đang xem)</span></span></li>';
    } else {
        if(paged - 4 > 0) {
            // hien thi nut ve trang dau, neu trang hien tai > 3;
            htmlPagination += '<li><a href="javascript:void(0);" data-page="1"><span class="arrow">«</span>Đầu</a></li>';
        }

        var b = paged - 3, c = paged + 3;
        if (b <= 0) {
            c -= (b - 1);
            b = 1;
        }
        ...
        for (var p = b; p <= c; p++) {
            if(p === paged) {
                htmlPagination += '<li class="active"><span>'+p+'<span class="sr-only"> (đang xem)</span></span></li>';
            } else {
                htmlPagination += '<li><a href="javascript:void(0);" data-page="'+p+'">'+p+'</a></li>';
            }
        }
        if(c < totalPage - 1) {
            htmlPagination += '<li><span>...</span></li>';
        }
        if(totalPage - paged > 4) {
            // hien thi nut ve trang dau, neu trang hien tai > 3;
            htmlPagination += '<li><a href="javascript:void(0);" data-page="' +totalPage+'">Cuối<span class="arrow">»</span></a></li>';
        }
    }

    $('.pagination-container .pagination').empty().html(htmlPagination);
}

function loadListTruyenHot(ajaxUrl, catId) {
...
function loadListTruyenMoi(ajaxUrl, catId) {
    $.get(ajaxUrl, {
        action: 'blogtruyen_ajax',
        type: "new_select",
        catid: catId
...
function loadListTruyenTop(ajaxUrl, time, classAct) {
    $.get(ajaxUrl, {
        action: 'blogtruyen_ajax',
        type: "top_switch",
        time: time
